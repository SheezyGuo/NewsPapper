...
//				e.printStackTrace();
			...
			if(state ==200 || state ==201){
				...
				try {
					...
					allWeWillDo(s1.toString(),bqtitle,bqcontent,bqdate,bqnewsource ,bqcategroy ,bqbuf,encode ,newsource , newtable,photourl,imageurl,imagescr,imagebuf,year,month,date);
				} catch (Exception e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					return ;
